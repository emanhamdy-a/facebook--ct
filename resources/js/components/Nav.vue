<template>
  <div class="bg-white h-12 flex px-4 items-center border-b border-gray-400 shadow-sm">
      ...
      <div class="flex">
        ...
        <div class="ml-2 relative">
          ...
          <input type="text" name="search"
            class="w-56 bg-gray-300 h-8 rounded-full pl-8 focus:outline-none focus:shadow-outline text-sm" placeholder="Search Facebook">
        </div>
      </div>
    </div>
    <div class="w-1/3 flex justify-center items-center h-full">
      <router-link to="/"
        class="px-8 border-b-2 border-blue-400 h-full flex items-center ">
      ...
      <router-link
        ...
        class="px-8 border-b-2 border-white-400 h-full flex items-center ">
        <img
    ...
    <div class="w-1/3">
      <svg xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        class="float-right fill-current w-5 h-5">
