...
class FriendsTest extends TestCase
{
  ...
  /** @test */
  public function an_inverse_friendship_is_retrieved_when_fetching_the_profil()
  {
      $this->actingAs($user = factory(\App\User::class)->create(), 'api');
      $anotherUser = factory(\App\User::class)->create();
      $friendRequest = \App\Friend::create([
...
// vendor\bin\phpunit --filter friend_requests_can_be_accepted
// vendor\bin\phpunit --filter only_valid_friend_requests_can_be_accepted
