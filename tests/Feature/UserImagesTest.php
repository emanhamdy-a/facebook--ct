...
use Illuminate\Foundation\Testing\DatabaseTransactions;
  ...
  public function users_are_returned_with_their_images()
  {
    ...
    $cover=$this->post('/api/user-images', [
      'image' => $file,
      'width' => 850,
      'height' => 300,
      'location' => 'cover',
    ...
    $profile=$this->post('/api/user-images', [
      'image' => $file,
      'width' => 850,
      'height' => 300,
      'location' => 'profile',
      ...
      'data' => [
        ...
        'attributes' => [
          'cover_image' => [
            'data' => [
              'type' => 'user-images',
              'user_image_id' => $cover['data']['user_image_id'],//1,
              'attributes' => []
            ],
          ],
          'profile_image' => [
            'data' => [
              'type' => 'user-images',
              'user_image_id' => $profile['data']['user_image_id'],//2,
              'attributes' => []
            ],
          ],
        ]
...
// vendor\bin\phpunit --filter images_can_be_uploaded
// vendor\bin\phpunit --filter users_are_returned_with_their_images
